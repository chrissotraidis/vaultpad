...
void gameMouseSetMode(int mode)
{
    ...
    // Hybrid and touch modes use direct taps in the world view. Trackpad mode
    // retains the classic relative cursor for players who prefer it.
#if __APPLE__ && TARGET_OS_IOS
    touch_set_touchscreen_mode(!settings.input.isTrackpad());
#else
